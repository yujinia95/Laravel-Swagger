...
#[
    ...
    OA\Server (url: 'https://laravel-swagger-yj.azurewebsites.net/', description: "staging server"), 
    OA\Server(url: 'https://laravel-swagger-yj.azurewebsites.net/', description: "production server"),
